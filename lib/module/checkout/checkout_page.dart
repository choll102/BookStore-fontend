...
import 'package:da_muasachonline/data/remote/order_service.dart';
...
import 'package:da_muasachonline/module/checkout/checkout_bloc.dart';
...
import 'package:da_muasachonline/shared/widget/btn_cart_action.dart';
import 'package:da_muasachonline/shared/widget/normal.button.dart';
import 'package:flutter/material.dart';
import 'package:flutter_money_formatter/flutter_money_formatter.dart';
import 'package:provider/provider.dart';
import 'package:da_muasachonline/event/removed_cart_event.dart';
    ...
    return Consumer<CheckoutBloc>(builder: (context, bloc, child) {
      return Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text(
             'Tổng Giá : ' '${FlutterMoneyFormatter(settings: MoneyFormatterSettings(
                symbol: 'vnđ',
                fractionDigits: 0,
